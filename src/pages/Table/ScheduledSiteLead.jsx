...
// end search data section 
  ...
  const handleSearch = async (page = 1) => {
    try {
      const payload = { lead_status: "10", page,tl_id:tl,agent_id:agent,project:project };
  ...
  return (
    <div>
      <h2 className="mb-2 text-center textsize headingstyle">Scheduled Site Visit</h2>
      {/* Filter Section */}
...
export default ScheduledSiteLead;
