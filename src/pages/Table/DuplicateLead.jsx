...
console.log("get data",contactNumber)
...
// end search data section 
  ...
  const handleSearch = async (page = 1) => {
    try {
      const payload = {  contact:contactNumber};
      console.log(payload)
      const token = localStorage.getItem("token");

      const res = await api.post("/get-duplicate-lead", payload, {
  ...
  return (
    <div>
      <h2 className="mb-2 text-center textsize headingstyle">Duplicate Leads</h2>
      {/* Filters */}
